...
public class SessionAggrStat {
    ...
    private double visit_length_1s_4s_ratio;
    private double visit_length_4s_7s_ratio;
    private double visit_length_7s_10s_ratio;
    ...
    private double step_length_10_29_ratio;
    private double step_length_30_59_ratio;
    ...
    public double getVisit_length_1s_4s_ratio() {
        return visit_length_1s_4s_ratio;
    }

    public void setVisit_length_1s_4s_ratio(double visit_length_1s_4s_ratio) {
        this.visit_length_1s_4s_ratio = visit_length_1s_4s_ratio;
    }

    public double getVisit_length_4s_7s_ratio() {
        return visit_length_4s_7s_ratio;
    }

    public void setVisit_length_4s_7s_ratio(double visit_length_4s_7s_ratio) {
        this.visit_length_4s_7s_ratio = visit_length_4s_7s_ratio;
    }

    public double getVisit_length_7s_10s_ratio() {
        return visit_length_7s_10s_ratio;
    }

    public void setVisit_length_7s_10s_ratio(double visit_length_7s_10s_ratio) {
        this.visit_length_7s_10s_ratio = visit_length_7s_10s_ratio;
    }
    ...
    public double getStep_length_10_29_ratio() {
        return step_length_10_29_ratio;
    }

    public void setStep_length_10_29_ratio(double step_length_10_29_ratio) {
        this.step_length_10_29_ratio = step_length_10_29_ratio;
    }

    public double getStep_length_30_59_ratio() {
        return step_length_30_59_ratio;
    }

    public void setStep_length_30_59_ratio(double step_length_30_59_ratio) {
        this.step_length_30_59_ratio = step_length_30_59_ratio;
    }
